  ...
  jQuery(function($) {
      ...
      <li class="block bg-[#F4F4F4]">
          <div class="pl-14 pr-8 pt-4 pb-4">
              ...
              <div class="text-sm my-4">
                  New enquiries: <a href="tel:61${new_enquiries.split(" ").join("")}" class="underline hover:no-underline">${new_enquiries}</a><br />
                  Existing clients: <a href="tel:61${existing_client.split(" ").join("")}" class="underline hover:no-underline">${existing_client}</a>
              </div>
              <div class="mt-4">
    ...
    function serviceProviderItem(provider_id, location_name, location_city, location_postcode, location_distance2, service_types, location_address, link, location_lat, location_lng, contact_numbers) {
      ...
      for (var i = 0; i < service_types.length; i++) {
        ...
        service_type_tags += '<span class="inline-block text-[11px] px-3 py-1 rounded-md bg-white border border-brand-sea text-brand-sea shadow-sm">' + tag[0] + "</span>";
      }
