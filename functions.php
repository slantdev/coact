 ...
 * @return array
 */
function coact_nav_menu_add_li_class( $classes, $item, $args, $depth ) {
...
add_filter( 'nav_menu_css_class', 'coact_nav_menu_add_li_class', 10, 4 );
 ...
 * @return array
 */
function coact_nav_menu_add_submenu_class( $classes, $args, $depth ) {
...
add_filter( 'nav_menu_submenu_css_class', 'coact_nav_menu_add_submenu_class', 10, 3 );
