        ...
        <div class="absolute inset-0 flex items-center p-12">
          <div class="w-1/2 font-montserrat">
            <div class="mb-16 flex gap-x-3 items-center text-black"><span>Home</span><svg xmlns="http://www.w3.org/2000/svg" width="9.245" height="15.38" viewBox="0 0 9.245 15.38">
              ...
              </svg><span class="font-bold">News & Resources</span></div>
            <h2 class="text-5xl text-black font-bold mb-4">What does the 2023 Budget mean for job seekers?</h2>
            <div class="text-xl text-black font-medium mt-4">
              Everyone on Jobseeker The JobSeeker rate will undergo a permanent rise for all beneficiaries, by $40 per fortnight.
            </div>
            <div class="flex gap-x-4 mt-8">
              <a href="#" class="px-6 py-3 rounded-full border border-solid font-semibold font-poppins text-xl bg-white border-transparent text-brand-sea">Read more</a>
            </div>
          </div>
        </div>
      </div>
...
<section class="relative">
  ...
  <div class="relative container max-w-screen-xxl mx-auto pt-0 lg:pt-20 pb-12 lg:pb-20 xl:pb-36">
    <div class="relative z-10">
      <div>
        <div class="not-prose">
          <h3 class="mb-4 xl:mb-8 text-left text-4xl font-bold text-brand-sea">News & Resources</h3>
        </div>
      ...
      <div class="mb-14 px-12 lg:px-14 relative -mx-2 lg:-mx-0">
        <div id="case-studies-filter" class="swiper mt-10 px-2 pt-2 pb-4 swiper-initialized swiper-horizontal swiper-pointer-events">
          <div class="swiper-wrapper filter-case-study-buttons" id="swiper-wrapper-98301056e5f198879" aria-live="polite">
            ...
            <div class="swiper-slide w-auto"><button type="button" class="filter-case-study inline-block rounded-full px-6 py-1.5 h-9 lg:h-auto text-sm lg:text-base lg:px-10 lg:py-2.5 bg-white border border-neutral-100 shadow-md hover:shadow-lg transition-all duration-200">Disability</button></div>
            <div class="swiper-slide w-auto"><button type="button" class="filter-case-study inline-block rounded-full px-6 py-1.5 h-9 lg:h-auto text-sm lg:text-base lg:px-10 lg:py-2.5 bg-white border border-neutral-100 shadow-md hover:shadow-lg transition-all duration-200">Job Search</button></div>
            <div class="swiper-slide w-auto"><button type="button" class="filter-case-study inline-block rounded-full px-6 py-1.5 h-9 lg:h-auto text-sm lg:text-base lg:px-10 lg:py-2.5 bg-white border border-neutral-100 shadow-md hover:shadow-lg transition-all duration-200">Tips & Tools</button></div>
            <div class="swiper-slide w-auto"><button type="button" class="filter-case-study inline-block rounded-full px-6 py-1.5 h-9 lg:h-auto text-sm lg:text-base lg:px-10 lg:py-2.5 bg-white border border-neutral-100 shadow-md hover:shadow-lg transition-all duration-200">Support</button></div>
            <div class="swiper-slide w-auto"><button type="button" class="filter-case-study inline-block rounded-full px-6 py-1.5 h-9 lg:h-auto text-sm lg:text-base lg:px-10 lg:py-2.5 bg-white border border-neutral-100 shadow-md hover:shadow-lg transition-all duration-200">WFA</button></div>
            <div class="swiper-slide w-auto"><button type="button" class="filter-case-study inline-block rounded-full px-6 py-1.5 h-9 lg:h-auto text-sm lg:text-base lg:px-10 lg:py-2.5 bg-white border border-neutral-100 shadow-md hover:shadow-lg transition-all duration-200">TTW</button></div>
          </div>
      ...
      <script>
        const news_filter = new Swiper('#case-studies-filter', {
          slidesPerView: 'auto',
          spaceBetween: 12,
          loop: false,
          watchOverflow: true,
      ...
      <div class="grid grid-cols-3 gap-x-8 gap-y-16">
        ...
        <div class="relative block">
          <a class="block aspect-w-16 aspect-h-10 overflow-hidden rounded-2xl">
            <img src="https://picsum.photos/400/300?random=24" alt="" class="object-cover">
          </a>
          <h4 class="text-xl font-semibold my-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor</h4>
          <div>Lorem ipsum dolor sit amet, ipsum labitur lucilius mel id, ad has appareat.</div>
          <a href="#" class="text-brand-sea underline font-medium inline-block mt-4">LEARN MORE</a>
        ...
        <div class="relative block">
          <a class="block aspect-w-16 aspect-h-10 overflow-hidden rounded-2xl">
            <img src="https://picsum.photos/400/300?random=29" alt="" class="object-cover">
          </a>
          <h4 class="text-xl font-semibold my-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor</h4>
          <div>Lorem ipsum dolor sit amet, ipsum labitur lucilius mel id, ad has appareat.</div>
          <a href="#" class="text-brand-sea underline font-medium inline-block mt-4">LEARN MORE</a>
        ...
        <div class="relative block">
          <a class="block aspect-w-16 aspect-h-10 overflow-hidden rounded-2xl">
            <img src="https://picsum.photos/400/300?random=30" alt="" class="object-cover">
          </a>
          <h4 class="text-xl font-semibold my-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor</h4>
          <div>Lorem ipsum dolor sit amet, ipsum labitur lucilius mel id, ad has appareat.</div>
          <a href="#" class="text-brand-sea underline font-medium inline-block mt-4">LEARN MORE</a>
