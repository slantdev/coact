...
<div id="service-locator" class="bg-[#F4F4F4] px-4 lg:px-6 pb-16">

  <div class="service_locator-wrap bg-white rounded lg:rounded-xl shadow-lg lg:shadow-xl pb-8">
    <div class="flex gap-x-4 justify-between items-center px-4 py-5 lg:py-8 lg:px-8 gap-y-4 lg:gap-x-10">
      <div class="flex flex-col md:flex-row md:gap-x-16">
        <div class="inline-flex items-center gap-x-2 md:gap-x-4">
          <svg class="w-5 h-5 lg:h-10 lg:w-10" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <h2 class="text-lg md:text-2xl lg:text-3xl font-bold whitespace-nowrap"><?php echo get_the_title() ?></h2>
        </div>
    ...
    <div class="service_locator">
      <div class="service_locator-content_wrapper">
        ...
        <div class="service_locator-content flex flex-col lg:flex-row">
            ...
            <div class="service_locator-search grow-0 border-b border-[#ccc]">
              <div class="service_locator-panel bg-brand-sea rounded-lg shadow-md p-4 xl:py-6 xl:px-10 relative z-20">
                <div class="service_locator-title font-bold flex gap-x-3">
                  ...
                  <span class="text-sm lg:text-base mb-4 lg:mb-6">Find your nearest service provider</span>
                </div>
          ...
          <div id="service_locator-map" class="service_locator-map z-0 bg-[#e5e3df] w-full lg:-ml-2 border-b border-[#ccc]">
          </div>
        </div>
      </div>
    </div>
...
<div id="filter-state" class="bg-white px-4 lg:px-6 py-16" style="--section-link-color:#45C2BF;">
  <div class="relative container max-w-screen-xxl mx-auto px-0">
    <div>
      <?php if ($headline) : ?>
        <div class="not-prose">
          <h3 class="mb-4 xl:mb-8 text-left text-2xl md:text-3xl xl:text-4xl font-bold" style="<?php echo $headline_style ?>"><?php echo $headline ?></h3>
        </div>
      <?php endif; ?>
