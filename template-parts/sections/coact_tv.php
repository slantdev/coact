      ...
      <?php if ($show_filter && $filter_style == 'tabs') : ?>
        <div class="posts-filter-<?php echo $posts_grid_id ?> relative pt-10">
          <div class="px-12 lg:px-14 relative -mx-2 lg:-mx-0">
            ...
            <button type="button" class="filter-button-prev absolute left-0 top-2 lg:top-[12px] w-9 h-9 lg:w-10 lg:h-10 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-brand-sea text-gray-500 hover:text-white transition-all duration-200 swiper-button-disabled" aria-label="Previous filters">
            ...
            <button type="button" class="filter-button-next absolute right-0 top-2 lg:top-[12px] w-9 h-9 lg:w-10 lg:h-10 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-brand-sea text-gray-500 hover:text-white transition-all duration-200" aria-label="Next filters">
