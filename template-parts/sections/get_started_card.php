...
$section_link_rgb = hexToRgb($section_link_color);
$card_hover_bg_color = 'rgb(' . $section_link_rgb["r"] . ' ' . $section_link_rgb["g"] . ' ' . $section_link_rgb["b"] . ' / 0.8)';
$section_style .= ' --section-card-hover-bg-color:' . $card_hover_bg_color . ';';
        ...
        <?php if ($content_cards_count > 1) { ?>
          <div class="content-cards-filter-<?php echo $content_cards_id ?> relative container max-w-screen-xxl mx-auto">
            <div class="px-12 lg:px-14 relative -mx-2 lg:-mx-0">
              ...
              <button type="button" class="filter-button-next absolute right-0 top-2 lg:top-[12px] w-9 h-9 lg:w-10 lg:h-10 flex items-center justify-center bg-white rounded-full shadow-md text-gray-500 hover:text-white transition-all duration-200">
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="content-card content-card-<?php echo $key; ?> relative container max-w-screen-3xl mx-auto <?php echo $content_card_class ?>">
                  ...
                  <div class="absolute left-0 -bottom-16 right-0">
                    <div class="container max-w-screen-3xl mx-auto">
                      <div class="swiper-pagination text-center relative [&>.swiper-pagination-bullet]:rounded-sm [&>.swiper-pagination-bullet]:w-10 md:[&>.swiper-pagination-bullet]:w-20" style="--swiper-pagination-bullet-height:6px;--swiper-pagination-bullet-inactive-color:#E2E2E2;--swiper-pagination-bullet-horizontal-gap:6px;--swiper-theme-color:var(--section-link-color);--swiper-pagination-bullet-inactive-opacity:1;"></div>
                    </div>
                  </div>
                  <div class="swiper-button-prev left-0 lg:left-4 after:content-['prev'] after:text-lg after:lg:text-3xl text-brand-sea font-bold" style="color: var(--section-link-color);"></div>
                  <div class="swiper-button-next right-0 lg:right-4 after:content-['next'] after:text-lg after:lg:text-3xl text-brand-sea font-bold" style="color: var(--section-link-color);"></div>
                  <script>
