  ...
  <div class="relative <?php echo $section_padding_top . ' ' . $section_padding_bottom ?>">
    ...
    <div class="relative container max-w-screen-xxl mx-auto z-10 <?php echo $entrance_animation_class ?>">
      ...
      <?php if ($show_filter && $filter_style == 'tabs' && $mergedFilters) : ?>
        <nav class="posts-filter-<?php echo $posts_grid_id ?> relative pt-10" aria-label="Filter by category">
          <div class="px-12 lg:px-14 relative -mx-2 lg:-mx-0">
            ...
            <button type="button" class="filter-button-prev absolute left-0 top-2 lg:top-[12px] w-9 h-9 lg:w-10 lg:h-10 flex items-center justify-center bg-white rounded-full shadow-md text-gray-500 hover:text-white transition-all duration-200 swiper-button-disabled" aria-label="Previous filters">
            ...
            <button type="button" class="filter-button-next absolute right-0 top-2 lg:top-[12px] w-9 h-9 lg:w-10 lg:h-10 flex items-center justify-center bg-white rounded-full shadow-md text-gray-500 hover:text-white transition-all duration-200" aria-label="Next filters">
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <script type="text/javascript">
        jQuery(document).ready(function($) {
          ...
          $('.posts-filter-<?php echo $posts_grid_id ?> .filter-button').on('click', function(event) {
            $('.posts-filter-<?php echo $posts_grid_id ?> .filter-button').removeClass('filter-active').attr('aria-pressed', 'false');
