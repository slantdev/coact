...
jQuery(function ($) {
  function setMapHeight() {
    ...
    const service_locator_form_height = $(
      ".service_locator-search"
    ).outerHeight();
    ...
    if (window.matchMedia("(max-width: 1024px)").matches) {
      // functionality for screens above than 960px
      // $(
      //   ".service_locator, .service_locator-content_wrapper, .service_locator-wrap"
      // ).css("height", map_height + "px");
      //$(".service_locator-wrap").css("height", map_height + "px");
      ...
      // $(".service_locator-listing").css(
      //   "height",
      //   map_height -
      //     service_locator_form_height -
      //     service_locator_infobar_height +
      //     "px"
      // );
    }
  ...
  // Create Service provider item template
          ...
          <div class="pl-14 pr-8 pt-4 pb-4">
              ...
              <div class="text-sm my-4">
                  New enquiries: <a href="tel:61${new_enquiries
                    ...
                    .join(
                      ""
                    )}" class="text-brand-blue underline hover:no-underline">${new_enquiries}</a><br />
                  Existing clients: <a href="tel:61${existing_client
                    .split(" ")
                    .join(
                      ""
                    )}" class="text-brand-blue underline hover:no-underline">${existing_client}</a>
              </div>
              <div class="mt-4">
  ...
  function serviceProviderItem(
    ...
    for (var i = 0; i < service_types.length; i++) {
      ...
      service_type_tags +=
        '<span class="inline-block text-[11px] px-3 py-1 rounded-md bg-brand-sea border border-brand-sea text-black font-medium shadow-sm">' +
        tag[0] +
        "</span>";
    }
    ...
    // Append location item to the list
    $(".service_locator-listing_tabs").append(
      createProviderItem(
        link,
        location_name,
        location_address,
  ...
  $(
    ".service_locator-details_overlay, .service_locator-details_header .back-button, .service_locator-details_header .close-button"
  ).click(function (e) {
    e.preventDefault();
