...
function coact_enqueue_scripts()
{
  ...
  if (is_page_template('template-parts/template-service-locator.php') || is_singular('service-partner')) {
    wp_enqueue_script('google-maps', 'https://maps.googleapis.com/maps/api/js?key=' . GOOGLE_MAPS_API . '&libraries=places,geometry&callback=Function.prototype', array(), $theme->get('Version'), true);
  }
